...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex items-center justify-between w-full px-4 h-14">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-amber-50">Finance AI</span>
          </Link>

          {!session && (
            <Button variant="ghost" size="sm" className="text-stone-300 hover:text-amber-50" asChild>
      ...
      <main className="flex-1">
        <section className="relative min-h-[85vh] flex flex-col items-center justify-center py-16 lg:py-24">
          <div className="container flex max-w-[64rem] flex-col items-center justify-center gap-4 text-center px-4">
            <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl mx-auto max-w-3xl text-amber-50">
              Gérez vos finances avec l&apos;aide de l&apos;IA
              <Rocket className="inline-block ml-2 md:ml-3 h-7 w-7 md:h-8 md:w-8 text-amber-200 align-middle" />
            </h1>
            <p className="max-w-[42rem] leading-normal text-stone-300 sm:text-xl sm:leading-8 mb-10 mx-auto">
        ...
        <section className="w-full py-12 md:py-16 bg-background/50 backdrop-blur-sm relative z-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center mb-12">
              <h2 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl text-amber-50">
                Fonctionnalités
              </h2>
              <p className="max-w-[85%] leading-normal text-stone-300 sm:text-lg sm:leading-7">
                Découvrez comment Finance AI peut vous aider à mieux gérer votre argent.
              </p>
            </div>

            <div className="mx-auto grid justify-center gap-6 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
              <div className="relative overflow-hidden rounded-lg border border-stone-800 bg-stone-900/50 backdrop-blur-sm p-2">
                <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                  <ListChecks className="h-12 w-12 text-amber-200" />
                  <div className="space-y-2">
                    <h3 className="font-bold text-amber-100">Suivi des dépenses</h3>
              ...
              <div className="relative overflow-hidden rounded-lg border border-stone-800 bg-stone-900/50 backdrop-blur-sm p-2">
                <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-amber-100">Objectifs d&apos;épargne</h3>
                    <p className="text-sm text-stone-300">
              ...
              <div className="relative overflow-hidden rounded-lg border border-stone-800 bg-stone-900/50 backdrop-blur-sm p-2">
                <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                  <ArrowRightLeft className="h-12 w-12 text-amber-200" />
                  <div className="space-y-2">
                    <h3 className="font-bold text-amber-100">Transactions récurrentes</h3>
                    <p className="text-sm text-stone-300">
              ...
              <div className="relative overflow-hidden rounded-lg border border-stone-800 bg-stone-900/50 backdrop-blur-sm p-2">
                <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                  <PieChart className="h-12 w-12 text-amber-200" />
                  <div className="space-y-2">
                    <h3 className="font-bold text-amber-100">Rapports détaillés</h3>
                    <p className="text-sm text-stone-300">
              ...
              <div className="relative overflow-hidden rounded-lg border border-stone-800 bg-stone-900/50 backdrop-blur-sm p-2">
                <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-bold text-amber-100">Assistant IA</h3>
                    <p className="text-sm text-stone-300">
              ...
              <div className="relative overflow-hidden rounded-lg border border-stone-800 bg-stone-900/50 backdrop-blur-sm p-2">
                <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                  <Rocket className="h-12 w-12 text-amber-200" />
                  <div className="space-y-2">
                    <h3 className="font-bold text-amber-100">Multi-comptes</h3>
                    <p className="text-sm text-stone-300">
      ...
      {/* Section Footer */}
      <footer className="relative z-30 bg-background border-t mt-auto py-3">
